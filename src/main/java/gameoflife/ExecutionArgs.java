...
public record ExecutionArgs(String patternFile, int maxWindowWidth, int maxWindowHeight,
                            ...
                            DispatcherType dispatcherType, int channelSize
) {
    ...
    public static ExecutionArgs parse(String[] args) {
        ...
        return new ExecutionArgs(
                ...
                args.length > 10 ? DispatcherType.valueOf(args[11]) : DispatcherType.DEFAULT,
                args.length > 11 ? Integer.parseInt(args[12]) : 1
        );
    }

    public static ExecutionArgs create(int padding, DispatcherType dispatcherType, int channelSize) {
        return new ExecutionArgs(
                DEFAULT_PATTERN,
